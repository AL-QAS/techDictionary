...
<h3>Tech-dictionary</h3>
    ...
    <div className="forgt-pss-ctn-main-1">
      ...
      <p>Create a new password so you can login and access our Tech-dictionary.</p>
        <div className="bg-white">
      <div className=" login-inputs-ctn">
        <input type="password" placeholder="New Password" className="input-fields"/>
        <input type="password" placeholder="Confirm Password" className="input-fields"/>


<button className="button-style">Reset assword</button>
