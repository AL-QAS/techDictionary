...
const columns = [
  ...
  const rows = [
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile  refers to someone not physically or.......", "Open"),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Open",),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Resolved",),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Open",),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Open",),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Open",),
    createData('#123', "19 May 2024", "Jane Doe",  "Juvenile", "the noun juvenile refers to someone not physically or.......", "Resolved",),
        ...
        {columns.map((column) => (
          ...
          >
            {row[column.id]}
              {column.id === "status" && (
                <div className='More'>
                    <img src={More} width={20} alt="More" onClick={() => hanndleMenu(rowIndex)}/>
                    {Menu[rowIndex] && (
                      <div className='Menu'>
                        <p>delete</p>
                      </div>
